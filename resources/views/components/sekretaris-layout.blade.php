@props(['activeMenu' => 'verifikasi', 'headerTitle' => 'Verifikasi — Sekretaris'])
...
<body style="margin:0; font-family: Arial, sans-serif; background:#F3F4F6;">
    ...
    <div style="display:flex; min-height:calc(100vh - 60px);">
        ...
        <div style="width:220px; background:#ffffff; border-right:1px solid #E5E7EB; padding:20px 0;">
            @php
                $menuItems = [
                    'verifikasi' => ['label' => 'Verifikasi', 'route' => 'sekretaris.verifikasi'],
                    'kelola-data-anggota' => ['label' => 'Kelola Data Anggota', 'route' => 'sekretaris.kelola-data-anggota.riwayat-perubahan'],
                ];
            @endphp
